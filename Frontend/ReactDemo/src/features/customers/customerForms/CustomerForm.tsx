...
import { Customer, CustomerModelInput } from '../../../types/Nonconstants'
import { AddOrUpdateCustomerMutation } from '../../../graphql/mutations/AddOrUpdateCustomer'
...
export default function CustomerForm({ customer }: CustomerFormProps) {
	...
	] = useMutation(AddOrUpdateCustomerMutation)
